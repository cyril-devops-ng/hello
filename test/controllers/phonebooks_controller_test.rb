...
class PhonebooksControllerTest < ActionController::TestCase
  ...
  test "should create phonebook" do
    assert_difference('Phonebook.count') do
      post :create, phonebook: { address: @phonebook.address, email: @phonebook.email, fullname: @phonebook.fullname, phoneno: @phonebook.phoneno }
    end
  ...
  test "should update phonebook" do
    patch :update, id: @phonebook, phonebook: { address: @phonebook.address, email: @phonebook.email, fullname: @phonebook.fullname, phoneno: @phonebook.phoneno }
    assert_redirected_to phonebook_path(assigns(:phonebook))
  end
